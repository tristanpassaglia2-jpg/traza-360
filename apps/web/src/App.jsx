...
const [respuestasPanico, setRespuestasPanico] = useState({}); 
 ...
 async function ejecutarPanico() {
  ...
  // Realtime listener
  if (alertaActualId) {
    const canal = supabase.channel("respuestas_" + alertaActualId)
      .on("postgres_changes", {
        event: "INSERT",
        schema: "public",
      ...
      <div className="w-full max-w-sm rounded-3xl p-6 shadow-2xl" style={{ background: "#000000", border: "2px solid " + BRAND.red }}>
        <div className="text-center space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            <button onClick={function() { if(contactos.length>0) { enviarWhatsApp(contactos[0].telefono,"Estoy bien. Falsa alarma."); setPanicoEnviado(false); setAlertaActualId(null); setRespuestasPanico({}); } }}
              className="rounded-lg py-2 text-center active:scale-95"
          ...
          <button onClick={function() { setPanicoEnviado(false); setAlertaActualId(null); setRespuestasPanico({}); }}
